...
while True:
    try:
        with TelegramClient(StringSession(), API_KEY, API_HASH) as client:
            ...
            client.send_message(
                "me",
                f"Here is your TELEGRAM STRING SESSION\n(Tap to copy it)👇 \n\n `{session}` \n\n And Visit @official_learning_zone For Any Help!\n\n",
            )

            print(
                "Thanks for Choosing CrushBot Have A Good Time....Note That When You Terminate the Old Session ComeBack And Genrate A New String Session Old One Wont Work"
            )
    except:
        print("")
        print(
